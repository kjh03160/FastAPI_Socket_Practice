# Socket chatting practice with FastAPI
---

### 개발 일지
개발을 하면서 어려움이나 고민했던 부분, 느낀 점을 적고 있습니다.
- [21. 05. 12 친구 관계 설정 API, Query logging, jwt 로그아웃](https://www.notion.so/21-05-12-API-Query-logging-jwt-ca431c65b30f479997805322d474bf22)
- [21.04.28 친구 관계 설정, EC2, RDS, nginx, gunicorn 설정](https://www.notion.so/21-04-28-EC2-RDS-nginx-gunicorn-0e55e70f62c24aee831f943d4a12a15b)
